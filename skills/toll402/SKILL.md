---
name: toll402
description: Pay-per-call tools for AI agents via x402 (USDC on Base) — read pages/PDFs, extract JSON, verify emails, FX rates, provenance (human vs synthetic), trusted-source lookup, a 4.3M-business global directory with B2B sourcing (business_shortlist), LatAm ID validators, forge new tools, 2,000+ proxied x402 services. No API keys; free trial without a wallet; 30% on-chain referral share.
metadata:
  version: 1.1.0
